...
imagepath="Datasets/ICDAR2015/train/x/img_836.jpg"
image = cv2.imread(imagepath)
new_image = image
new_image2 = image

#Usa un reader CSV per estrarre le singole coordinate dal ground truth
coordinates="Datasets/ICDAR2015/train/y/gt_img_836.txt"
...
for i in range(0, reader.line_num):
    ...
    # new_image2 = cv2.rectangle(new_image2, (x1[i], y1[i]), (x3[i], y3[i]), (256,0,256))    
    # new_image2 = cv2.rectangle(new_image2, (x2[i], y2[i]), (x4[i], y4[i]), (0,0,205))
